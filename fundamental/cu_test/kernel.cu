...
int main(int argc, char ** argv) {
	...
	char fn_matches[200] = ".\\cu_test\\kusvod2\\matches_";
	strcat(fn_matches, filename);
	char fn_frames0[200] = ".\\cu_test\\kusvod2\\frames1_";
	strcat(fn_frames0, filename);
	char fn_frames1[200] = ".\\cu_test\\kusvod2\\frames2_";
	...
	char fn_I0[200] = ".\\cu_test\\kusvod2\\I1_";
	strcat(fn_I0, filename);
	char fn_I1[200] = ".\\cu_test\\kusvod2\\I2_";
	strcat(fn_I1, filename);

	char file_a[200] = ".\\csac_results\\csac_inliers_";
	char outliersstr[200] = ".\\csac_results\\ind_outliers_";
	char file_F[200] = ".\\csac_results\\F_";
	char file_abstraction[200] = ".\\csac_results\\abs_";
	char error_fn[200] = ".\\csac_results\\err_";
	//==============================================
...
//function value: n_temp is the number of inliers evaluated with the model modeled by the MSS host_result_MSS
	...
	{	//estimate the projection error 
		...
		////total number of correspondences|card_core| ninliers before reestimate | ninliers| cn2| Bitonic sort| RANSAC against core list| GPU| the whole time cost| proj_error 
